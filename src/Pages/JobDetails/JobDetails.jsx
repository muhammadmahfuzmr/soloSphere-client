...
const JobDetails = () => {
    ...
    const {category,  deadline , description, job_title, max_price, min_price, buyer, _id,  } =job
   console.log(job)
    const handleBidSubmit = async e =>{
        e.preventDefault()
        if(user?.email === buyer?.email) return toast.error("Action is not Permited")
        ...
        const bidData = {price, email, comment, category, job_title, buyer, jobId, status, deadline}
